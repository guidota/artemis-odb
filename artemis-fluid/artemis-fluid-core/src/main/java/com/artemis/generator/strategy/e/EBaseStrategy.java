...
public class EBaseStrategy implements BuilderModelStrategy {
    ...
    public void apply(ArtemisModel artemisModel, TypeModel model) {
        ...
        model.add(createStaticChangeRegistryField());
    ...
    private FieldDescriptor createStaticChangeRegistryField() {
        return new FieldBuilder(FluidTypes.CHANGEREGISTRY_TYPE,"_changeRegistry")
