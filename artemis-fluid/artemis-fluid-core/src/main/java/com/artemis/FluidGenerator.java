...
public class FluidGenerator {
    ...
    public void generate(Collection<Class<? extends Component>> components, Collection<Class<? extends FieldProxyStrategy>> fieldProxyStrategies, File outputDirectory, Log log, FluidGeneratorPreferences globalPreferences) {
        ...
        if (fieldProxyStrategies == null || fieldProxyStrategies.isEmpty()) {
            ...
            log.error("Fluid API: Make sure com.artemis.artemis:artemis-fluid-core is on your compile classpath for the plugin to find.");
        ...
        copyResourceIfMissing(getClass().getResource("/ChangeRegistry.java"), new File(outputArtemisModuleDirectory, "ChangeRegistry.java"));
        copyResourceIfMissing(getClass().getResource("/FluidEntityPlugin.java"), new File(outputArtemisModuleDirectory, "FluidEntityPlugin.java"));
        copyResourceIfMissing(getClass().getResource("/EBag.java"), new File(outputArtemisModuleDirectory, "EBag.java"));
        copyResourceIfMissing(getClass().getResource("/ESubscription.java"), new File(outputArtemisModuleDirectory, "ESubscription.java"));
        copyResourceIfMissing(getClass().getResource("/FluidIteratingSystem.java"), new File(outputArtemisModuleDirectory, "FluidIteratingSystem.java"));
    }
